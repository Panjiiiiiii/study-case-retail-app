...
import { deleteTransaction } from "@/app/action/transaction";

export default function DeleteTransaction({ id, onDelete, onCancel }) {
    const [isDeleting, setIsDeleting] = useState(false);

    const handleDelete = async () => {
        try {
            setIsDeleting(true);
            await deleteTransaction(id); // Server Action
